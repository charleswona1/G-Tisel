                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register first-name')}}" optionnal="optionnal" class="mb-3 text-primary">
                                            <input class="form-control" id="first-name" type="text" value="{{$user->fisrt_name}}" placeholder="{{__('register pfirst-name')}}" name="fisrt_name" />
                                        </x-form-group>
                                    </div>
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register last-name')}}" class="mb-3 text-primary">
                                            <input class="form-control" id="last-name" value="{{$user->last_name}}" type="text" placeholder="{{__('register plast-name')}}" name="last_name" />
                                        </x-form-group>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register country')}}" class="mb-3 text-primary">
                                            <input class="form-control" list="datalistOptions" value="{{$user->country}}" id="country" placeholder="{{__('register pcountry')}}" name="country">
                                    ...
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register city')}}" class="mb-3 text-primary">
                                            <input class="form-control" type="text" id="city" value="{{$user->city}}" placeholder="{{__('register pcity')}}" name="city" />
                                        </x-form-group>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register phone')}}" class="mb-3 text-primary">
                                            <input class="form-control" type="tel" id="phone" value="{{$user->phone}}" placeholder="{{__('register phone')}}" name="phone" />
                                        </x-form-group>
                                    </div>
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register postal')}}" class="mb-3 text-primary">
                                            <input class="form-control" type="number" id="codePostale" value="{{$user->codePostale}}" placeholder="{{__('register ppostal')}}" name="codePostale" />
                                        </x-form-group>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register user-name')}}" class="mb-3 text-primary">
                                            <input class="form-control" id="userName" value="{{$user->user_name}}" type="text" placeholder="{{__('register puser-name')}}" name="user_name" />
                                        </x-form-group>
                                    </div>
                                    <div class="col-lg-6">
                                        <x-form-group label="{{__('register email')}}" class="mb-3 text-primary">
                                            <input class="form-control" id="email" value="{{$user->email}}" type="email" placeholder="{{__('register pemail')}}" name="email" />
