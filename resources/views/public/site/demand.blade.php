                        ...
                        <!-- your steps content here -->
                            ...
                            <div id="techniq-info" class="content" role="tabpanel" aria-labelledby="account-part-trigger">
                                    ...
                                    <div class="col-lg-6">
                                        <x-form-group label="Nature de l'activité envisagée" class="mb-3 text-primary">
                                            <select name="activite_id" class="form-select">
                                                ...
                                                <option selected>Eolienne</option>
                                                <option selected>Hydro-electrique</option>
                                                <option selected>Thermique</option>
                                            </select>
                                        </x-form-group>
                                    </div>
                                </div>
                                ...
                                @if (1==0)
                                    ...
                                    <div class="col-lg-12">
                                        <x-form-group label="UUn extrait d'une carte à l'échelle 1/50 000imè de la région ou les ouvrages seront implantés " class="mb-3 text-primary">
                                            <input class="form-control" name="file15" accept="image/*,.pdf" type="file">
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les noms des cours d'eau, des lacs, des marées, le lieu de l'utilisation de l'énergie avec les noms des localités où les ouvrages seront établis " class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="nom_eau" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les ouvrages hydrauliques placés en amont ou en aval" class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="ouvrage_hydro" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Le profil en long du cours d'eau, du lac ou de la mer intéressant les travaux, ainsi que celui de la dérivation" class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="profil_long_eau" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Le profil en travers du lieu d'implantation des ouvrages" class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="profil_en_travers" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Un plan des terrains submersibles avec l’indication des diverses natures de cultures et la surface totale de chacune d’elle " class="mb-3 text-primary">
                                            <input class="form-control" name="file16" accept="image/*,.pdf" type="file">
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les caractéristiques du site à aménager la hauteur de la chute et le débit du cours d'eau respectivement de crue d'étiage et la crue exceptionnelle" class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="caracteristique_site" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les changements présumés que l'exécution des travaux et l'exploitation de l'usine pourront apporter au niveau du site à aménager et sur le régime des eaux, soit en amont, soit en aval " class="mb-3 text-primary">
                                            <input class="form-control" name="file17" accept="image/*,.pdf" type="file">
                                        </x-form-group>
                                    </div>
                                @endif
                                ...
                                @if (1==0)
                                    ...
                                    <div class="col-lg-12">
                                        <x-form-group label="Une carte de la région à l'échelle au 1/200 000imè au moins indiquant le tracé de la ligne " class="mb-3 text-primary">
                                            <input class="form-control" name="file15" accept="image/*,.pdf" type="file">
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Un plan à l'échelle 1/20 000ème au moins précisant la situation des lignes projetées par rapport aux habitations, aux lignes de télécommunications, aux adductions d'eau, aux réseaux électriques, aux routes, et une nomenclature des voies existantes ; ce plan doit revêtir le visa des concessionnaires et gestionnaires du domaine public concerné " class="mb-3 text-primary">
                                            <input class="form-control" name="file17" accept="image/*,.pdf" type="file">
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="La destination, les conditions générales et les dispositions principales du transport ou de distribution, les types d'ouvrage courants, les postes faisant partie du régine juridique demandé" class="mb-3 text-primary">
                                            <input class="form-control" name="file18" accept=".pdf" type="file">
                                        </x-form-group>
                                    </div>
                                @endif
                                ...
                                @if (1==1)
                                    ...
                                    <div class="col-lg-12">
                                        <x-form-group label="Les pays d'origine ou de destination de l'énergie électrique" class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="pays_origines" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les standards et les normes électriques homologués desdits pays " class="mb-3 text-primary">
                                            <input class="form-control" type="text" step="0.001" placeholder="" name="standart" />
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les contrats d'achat ou de fourniture pour lesquels la licence est demandée" class="mb-3 text-primary">
                                            <input class="form-control" name="file19" accept=".pdf" type="file">
                                        </x-form-group>
                                    </div>

                                    <div class="col-lg-12">
                                        <x-form-group label="Les contrats ou protocoles d'accord conclu avec les concessionnaires de transport ou de distribution, selon le cas pour l'acheminement de l'énergie électrique aux points de consommation " class="mb-3 text-primary">
                                            <input class="form-control" name="file20" accept=".pdf" type="file">
                                        </x-form-group>
                                    </div>
