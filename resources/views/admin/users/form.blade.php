            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <x-form-group label="Téléphone du personnel" class="mb-3 ">
                        <input class="form-control" type="text" placeholder="Entrez le telephone" name="phone" />
                    </x-form-group>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <x-form-group label="Code postale" class="mb-3 ">
                        <input class="form-control" type="number" placeholder="Entrez le code postale" name="codePostale" />
                    </x-form-group>
                </div>

                <div class="col-lg-6">
                    <x-form-group label="Adresse email" class="mb-3 ">
                        <input class="form-control" type="email" placeholder="Entrez l'adresse email" name="email" />
                    </x-form-group>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <x-form-group label="Poste occupé" class="mb-3 ">
                        <input class="form-control" type="text" placeholder="Entrez le poste" name="poste" />
                    </x-form-group>
                </div>
