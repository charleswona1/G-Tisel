...
<head>
    ...
    <style>
        ...
        */
        ...
        .form-control:focus {
            ...
            border-color: #86b7fe;
            outline: 0;
            box-shadow: 0 0 0 0.25rem rgba(31, 46, 71, 0.25);
        }
        ...
        .form-range:focus::-webkit-slider-thumb {
            box-shadow: 0 0 0 1px #fff, 0 0 0 0.25rem rgba(31, 46, 71, 0.25);
        }
        ...
        .btn-outline-primary:focus {
            box-shadow: 0 0 0 0.25rem rgba(31, 46, 71, 0.5);
        }
    ...
    <style>
        ...
        .wrapper {
            height: calc(100vh - 69.944px);
        }

        .img-bg {
            background-image: url("/assets/img/centrale.jpg");
            background-repeat: no-repeat;
            background-size: cover;
            background-attachment: fixed;
            border-radius: calc(0.75rem - 1px) 0 0 calc(0.75rem - 1px) !important;
        }
